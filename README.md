...
- 6: Neutral
- 7: *Boredom*
[^1]: *Distracted* is temporarily removed from our training dataset due to a failure in collecting meaningful images expressing this particular emotion. It may be added back in future if we're able to gather relevant images from other sources. Accordingly, integer labels of emotion classes after *Distracted* are bumped up by one.
